...
APatron_StateProjectile::APatron_StateProjectile() 
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &APatron_StateProjectile::OnHit);		// set up a notification for when this component hits something
