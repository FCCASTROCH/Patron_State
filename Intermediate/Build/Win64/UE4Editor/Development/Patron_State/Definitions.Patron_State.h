...
#define UE_PROJECT_NAME Patron_State
#define UE_TARGET_NAME Patron_StateEditor
#define UE_MODULE_NAME "Patron_State"
...
#define PATRON_STATE_API DLLEXPORT
