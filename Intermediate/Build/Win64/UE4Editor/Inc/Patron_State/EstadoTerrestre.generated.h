...
#ifdef PATRON_STATE_EstadoTerrestre_generated_h
#error "EstadoTerrestre.generated.h already included, missing '#pragma once' in EstadoTerrestre.h"
#endif
...
public: \
	DECLARE_CLASS(AEstadoTerrestre, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Patron_State"), NO_API) \
	DECLARE_SERIALIZER(AEstadoTerrestre) \
...
#define Patron_State_Source_Patron_State_EstadoTerrestre_h_16_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AEstadoTerrestre); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AEstadoTerrestre); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AEstadoTerrestre(AEstadoTerrestre&&); \
	NO_API AEstadoTerrestre(const AEstadoTerrestre&); \
public:
...
template<> PATRON_STATE_API UClass* StaticClass<class AEstadoTerrestre>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Patron_State_Source_Patron_State_EstadoTerrestre_h
